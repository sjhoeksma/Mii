...
//#define PIN_RESET			16	// D12
#define PIN_CE				0x04	// D10
//#define PIN_CE				0x02	// D9

#define PINS_CE_DC			(PIN_DC | PIN_CE)
#define PIN_BACKLIGHT 6     // D6 PWM
...
public:
	...
	void backLight(uint8_t value,uint8_t ledPin=PIN_BACKLIGHT);
	void clear();
...
static const PROGMEM uint8_t ASCII[][5] = {
	...
	,{ 0x00, 0x80, 0xF0, 0x80, 0x00 } // 80 Data-off
	,{ 0x00, 0x88, 0xF0, 0x88, 0x00 } // 81 Data-1
	,{ 0x04, 0x8A, 0xF4, 0x8A, 0x04 } // 82 Data-2
	,{ 0x05, 0x8A, 0xF4, 0x8A, 0x05 } // 83 Data-3
};

#define LAST_ASCII 0x83