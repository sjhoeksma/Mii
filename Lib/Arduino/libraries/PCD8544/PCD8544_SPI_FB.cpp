...
void PCD8544_SPI_FB::backLight(uint8_t value,uint8_t ledPin){
  pinMode(ledPin, OUTPUT);
  switch (value) {
   case 0x00: digitalWrite(ledPin,LOW);break;
   case 0xff: digitalWrite(ledPin,HIGH);break;
   default:analogWrite(ledPin, value);
  }
}
...
size_t PCD8544_SPI_FB::write(uint8_t data)
{
	...
	if (data < 0x20 || data > LAST_ASCII) return 0;
