...
//Check if the message size is big enough to receive timing_t message ()
  ...
  #error The MII_RF_MESSAGE_LEN is to small to support for this modem
#endif
...
public:
  ...
  MiiRF22Modem(uint8_t selectPin = MII_PIN_RF_CS, uint8_t intPin = MII_PIN_RF_IRQ, uint8_t sdnPin = MII_PIN_RF_SDN);
   ...
   /// \brief Defines register values for a set of modem configuration registers
    ...
    bool internalRecv(uint8_t* buf=0, uint8_t* len=0,bool peek=false);
...
#define MII_MODEM_CLASS MiiRF22Modem
