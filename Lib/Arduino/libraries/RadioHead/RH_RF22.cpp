...
PROGMEM static const RH_RF22::ModemConfig MODEM_CONFIG_TABLE[] =
{
    ...
    //Custom Modem FSK, 434,0.5,5
    //  1c,   1f,   20,   21,   22,   23,   24,   25,   2c,   2d,   2e,   58,   69,   6e,   6f,   70,   71,   72
    // FSK, No Manchester, Max Rb err <1%, Xtal Tol 20ppm
    { 0x2b, 0x03, 0xd0,  0xe0 , 0x10, 0x62, 0x00, 0x05, 0x40, 0x0a, 0x2b, 0x80, 0x60, 0x04, 0x19, 0x2c, 0x22, 0x08 },
...
//	Serial.println("IPKVALID");
  ...
  _rxTime=millis(); //++We want receive time of good message
	_rxGood++;
	_bufLen = len;
	_mode = RHModeIdle;
	_rxBufValid = true;
