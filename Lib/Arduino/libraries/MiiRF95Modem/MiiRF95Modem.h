...
#define RH_RF95_MAX_PAYLOAD_LEN MII_MAX_MESSAGE_LEN + 6
...
#define MII_TXPOW_1DBM                         5
#define MII_TXPOW_2DBM                         7
#define MII_TXPOW_5DBM                         8
#define MII_TXPOW_8DBM                         13
#define MII_TXPOW_11DBM                        16
#define MII_TXPOW_14DBM                        18
#define MII_TXPOW_17DBM                        21
#define MII_TXPOW_20DBM                        23
...
public:
   ...
   bool  init(uint8_t address,uint16_t syncWords=0x2dd4,uint8_t channel=1,uint8_t power=MII_TXPOW_17DBM,bool isMaster=false,ModemConfigChoice index=Bw125Cr48Sf4096);
    ...
    bool    internalRecv(uint8_t* buf, uint8_t* len);
...
private:
    ...
    static MiiRF95Modem*     _deviceForInterrupt;
